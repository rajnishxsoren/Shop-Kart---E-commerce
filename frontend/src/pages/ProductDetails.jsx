...
import CategroyWiseProductDisplay from '../components/CategoryWiseProductDisplay.jsx';
...
const ProductDetails = () => {
  ...
  return (
    <div className='container mx-auto p-10 bg-slate-100 '>
      ...
      <div className='min-h-[250px]  flex flex-col  lg:h-[70vh] w-full lg:flex-row p-3 gap-4 '>
          {/***product Image */}
          <div className='h-96 flex flex-col lg:flex-row-reverse  gap-4 '>
           ...
           {/***product details */}
           {
            ...
            (
              <div className='flex flex-col gap-1  p-3  lg:w-[40vw] overflow-hidden '>
                ...
                <div className='scrollbar-none overflow-y-scroll h-32'>
                  <p className='text-slate-700 size-medium my-1 text-ellipsis'>Description : </p>
